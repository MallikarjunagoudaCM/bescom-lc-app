...
router.post('/', requireRole('AE_BESCOM', 'SHIFT_JE_KPTCL', 'LINEMAN', 'ADMIN'), ctrl.create);

// Single LC
router.get('/:id', ctrl.getById);

// Stage transitions
router.patch('/:id/approve',        requireRole('AE_BESCOM', 'AEE', 'ADMIN'), ctrl.approve);
...
router.patch('/:id/delegate',       requireRole('AE_BESCOM', 'AE_KPTCL', 'SHIFT_JE_KPTCL', 'ADMIN'), ctrl.delegate);
