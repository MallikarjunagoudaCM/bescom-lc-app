...
router.patch('/:id/validate-pin',  requireRole('SHIFT_JE_KPTCL', 'ADMIN'),    ctrl.validatePin);
router.patch('/:id/delegate',       requireRole('AE_BESCOM', 'ADMIN'), ctrl.delegate);
router.patch('/:id/validate-secret-code', requireRole('AE_BESCOM', 'LINEMAN', 'ADMIN'), ctrl.validateSecretCode);
router.patch('/:id/validate-release-code', requireRole('SHIFT_JE_KPTCL', 'ADMIN'), ctrl.validateReleaseCode);
...
router.get('/:id/energize-readiness', requireRole('SHIFT_JE_KPTCL', 'ADMIN'), ctrl.getEnergizeReadiness);
router.patch('/:id/energize-feeder', requireRole('SHIFT_JE_KPTCL', 'ADMIN'), ctrl.energizeFeeder);
